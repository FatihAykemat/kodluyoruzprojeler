...
const btnAll = document
  .querySelector("#All")
  .addEventListener("click", listAll);
const btnKorean = document
  .querySelector("#Korea")
  .addEventListener("click", listKorean);
const btnJapan = document
  .querySelector("#Japan")
  .addEventListener("click", listJapan);
const btnChina = document
  .querySelector("#China")
  .addEventListener("click", listChina);
...
function listAll() {
  ...
  sectionContainer.innerHTML = all;
}
